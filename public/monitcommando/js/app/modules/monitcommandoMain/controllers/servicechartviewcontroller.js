 ...
 */
monitcommandoMainModule.globalAppData.controllers.serviceChartViewController = function(
    ...
    $scope.loadGraphs = function(responses) {
            ...
            var settings = {
                ...
                borderLineWidth: 0,
                padding: { left: 0, top: 5, right: 0, bottom: 10 },
        ...
        $scope.updateGraphs = function(responses) {
            ...
            if( typeof(dataOrb.data) !== 'undefined' && dataOrb.data.length > 0 ) {
                ...
                if (typeof (chart) !== 'undefined' && typeof (chart.update) !== "undefined") {
                    chart.update();
                }
            }
        };
