...
*/
angular.module('tv')
.directive('sideMenu', function($location, $mdTheming, tvTheming, SideMenu) {
    return {
        restrict: 'E',
        ...
        link: function($scope, $element, attrs) {
            ...
            attrs.$observe('mdTheme', function() {
                var menuColor = tvTheming.getThemeHue($mdTheme.$mdTheme, 'primary', 'default');
                var menuColorRGBA = tvTheming.rgba(menuColor.value);
