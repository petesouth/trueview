 ...
 */
angular.module('tv').
controller('AdminPanelController', function ($scope, $element, $timeout, $mdSidenav, $mdUtil, $state, user, config, Messages, $rootScope) {
    $rootScope.user = user.data;
    $rootScope.configInfo = config.data[0];

    Messages.newMessages($rootScope.user.org_id).success(function(data) {
