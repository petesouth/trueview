    ...
    return angular.module('gridster', [])
        ...
        .constant('gridsterConfig', {
            ...
            resizable: { // options to pass to resizable handler
                enabled: true,
                handles: ['s', 'e', 'n', 'w', 'se', 'ne', 'sw', 'nw', 'btn']
            },
            ...
            function GridsterResizable($el, scope, gridster, item, itemOptions) {
                ...
                function ResizeHandle(handleClass) {
                    ...
                    function expand_resize(e) {
                        ...
                        // only change sizeX if expand/shrink button clicked
                        if (['btn','sbtn'].indexOf(handleClass) !== -1) {
                    ...
                    function resizeStop(e) {
                        ...
                        if(item.sizeX == 2){
                            $dragHandle.addClass('expanded');
                            //('<md-icon name="unfold_more" md-font-icon="icon-unfold-more" style="color: white;transform: rotate(90deg);" class="ng-isolate-scope md-indigo-theme md-font icon-unfold-more" aria-hidden="true" ng-show="expandable"></md-icon>')

                        }else{
                            $dragHandle.removeClass('expanded');
                        }
                    ...
                    this.enable = function() {
                        if (!$dragHandle) {
                            $dragHandle = angular.element('<div class="gridster-item-resizable-handler handle-' + hClass + '">' +
                                '<md-icon name="unfold_more" md-font-icon="icon-unfold-more" style="color: white;transform: rotate(90deg);" class="ng-isolate-scope md-indigo-theme md-font icon-unfold-more" aria-hidden="true" ng-show="expandable"></md-icon>' +
                                    //    '<md-icon md-font-icon="icon-unfold-less" style="color: white;transform: rotate(90deg);" class="ng-isolate-scope md-indigo-theme md-font icon-unfold-less" aria-hidden="true" ng-show="!card_expandable"></md-icon>' +
                                '</div>');
            ...
            function($parse, GridsterDraggable, GridsterResizable, gridsterDebounce) {
                return {
                    ...
                    link: function(scope, $el, attrs, controllers) {
                        ...
                        var aspects = ['minSizeX', 'maxSizeX', 'minSizeY', 'maxSizeY', 'sizeX', 'sizeY', 'row', 'col', 'side'],
                            $getters = {};
